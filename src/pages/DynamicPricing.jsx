...
export default function DynamicPricing() {
  ...
  const handleUpdatePricing = async () => {
    try {
      setLoading(true);
      const response = await api.updateDynamicPricing(
      ...
      if (response && response.success) {
        ...
        alert(
          response.message || "Dynamic pricing settings updated successfully"
        );
        ...
        const errorMessage =
          response?.message || "Failed to update pricing settings";
        alert(errorMessage);
      }
    } catch (err) {
  ...
  const getRealTimePricingExamples = () => {
    ...
    return {
      ...
      weekendOffPeak: (
        basePrice *
        pricingForm.offPeakMultiplier *
        pricingForm.weekendMultiplier
      ).toFixed(2),
      weekendPeak: (
        basePrice *
        pricingForm.peakHourMultiplier *
        pricingForm.weekendMultiplier
      ).toFixed(2),
      weekendAfternoon: (
        basePrice *
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-2xl mx-auto px-4">
          ...
          <p className="text-gray-600 mb-6">
            Before you can manage dynamic pricing, you need to create a venue
            first. This will be your sports facility where customers can book
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-2xl mx-auto px-4">
          ...
          <p className="text-gray-600 mb-6">
            Before you can manage dynamic pricing, you need to add courts to
            your venue. Dynamic pricing rules are applied to individual courts.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Configure dynamic pricing rules to maximize revenue based on demand,
            ...
            {courts.map((court) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600">
                  Base: LKR {court.pricePerHour}/hour
                </p>
                <div className="mt-2">
                  <span
          ...
          <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center p-4 bg-orange-50 rounded-lg">
                  ...
                  <p className="text-lg font-semibold text-orange-900">
                    {selectedCourt.peakHourStart || "18:00"} -{" "}
                    {selectedCourt.peakHourEnd || "22:00"}
                  </p>
                  <p className="text-sm text-orange-600">
                    {selectedCourt.peakHourMultiplier
                      ? `${selectedCourt.peakHourMultiplier}x`
                      : "1.5x"}{" "}
                    multiplier
                  </p>
                  {selectedCourt.dynamicPricingEnabled && (
                    <p className="text-xs font-medium text-orange-800 mt-1">
                      ...
                      {(
                        ...
                        (selectedCourt.peakHourMultiplier || 1.5)
                      ).toFixed(2)}
                      /hour
                    </p>
                  )}
                ...
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-lg font-semibold text-blue-900">
                    {selectedCourt.weekendMultiplier
                      ? `${selectedCourt.weekendMultiplier}x`
                      : "1.2x"}{" "}
                    multiplier
                  </p>
                  ...
                  {selectedCourt.dynamicPricingEnabled && (
                    <p className="text-xs font-medium text-blue-800 mt-1">
                      ...
                      {(
                        selectedCourt.pricePerHour *
                        (selectedCourt.weekendMultiplier || 1.2)
                      ).toFixed(2)}
                      /hour
                    </p>
                  )}
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Based on current base price:{" "}
                <span className="font-semibold">
                  LKR {selectedCourt.pricePerHour}/hour
                </span>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <span className="font-semibold text-gray-900">
                          LKR {getRealTimePricingExamples().weekdayOffPeak}
                        </span>
                    ...
                    <div className="flex justify-between items-center p-3 bg-orange-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <span className="font-semibold text-orange-900">
                          LKR {getRealTimePricingExamples().weekdayPeak}
                        </span>
                    ...
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <span className="font-semibold text-gray-900">
                          LKR {getRealTimePricingExamples().weekdayLate}
                        </span>
                        <p className="text-xs text-gray-500">per hour</p>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <span className="font-semibold text-blue-900">
                          LKR {getRealTimePricingExamples().weekendOffPeak}
                        </span>
                    ...
                    <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                      <div>
                        ...
                        <p className="text-xs text-purple-600">
                          ...
                          {pricingForm.weekendMultiplier}x)
                        </p>
                      </div>
                      <div className="text-right">
                        <span className="font-semibold text-purple-900">
                          LKR {getRealTimePricingExamples().weekendPeak}
                        </span>
                    ...
                    <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <span className="font-semibold text-blue-900">
                          LKR {getRealTimePricingExamples().weekendAfternoon}
                        </span>
                        <p className="text-xs text-blue-600">per hour</p>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div>
                      ...
                      <span className="font-medium text-green-900 ml-2">
                        {pricingForm.peakHourStart} - {pricingForm.peakHourEnd}
                      </span>
                    </div>
                    <div>
                      <span className="text-green-700">Peak Multiplier:</span>
                      <span className="font-medium text-green-900 ml-2">
                        {pricingForm.peakHourMultiplier}x
                      </span>
                    </div>
                    <div>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setPricingForm({
                            ...pricingForm,
                            offPeakMultiplier: parseFloat(e.target.value),
                          })
                        }
                        className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500"
                      />
                    ...
                    <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                      <h6 className="font-medium text-blue-900 mb-2">
                        Live Preview (Base: LKR {selectedCourt?.pricePerHour}
                        /hour)
                      </h6>
